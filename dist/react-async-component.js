...
var AsyncComponentProvider = function (_Component) {
  ...
  function AsyncComponentProvider(props) {
    classCallCheck(this, AsyncComponentProvider);

    var _this = possibleConstructorReturn(this, (AsyncComponentProvider.__proto__ || Object.getPrototypeOf(AsyncComponentProvider)).call(this, props));

    _this.asyncContext = _this.props.asyncContext || createAsyncContext();
    _this.rehydrateState = _this.props.rehydrateState;
    return _this;
  }
